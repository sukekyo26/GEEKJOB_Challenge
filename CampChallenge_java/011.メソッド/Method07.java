 ...
 * @author sumi3
 */
public class Method07 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Method07</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Method07 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
            ...
            for(int x = 0; x <= 2; x++){
                if (get[x][2] == null){
                    ...
                    out.print(Arrays.toString(get[x]));
                    out.print("<br>");
                }
             }
        }
