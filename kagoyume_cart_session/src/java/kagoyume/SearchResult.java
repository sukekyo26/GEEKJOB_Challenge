...
public class SearchResult implements Serializable{
    private String keyword;//検索したキーワード
    private String categoryId;//カテゴリID(intでも良いと思うが一応String)
    private String sort;//ソート順
    private String highPrice;//最高金額で検索した数字(String)
    private String lowPrice;//最低金額で検索した数字(String)
    private int hitCount;//検索結果にヒットしたアイテム数
